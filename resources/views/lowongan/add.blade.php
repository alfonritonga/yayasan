    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="javascript:void(0)">Tambah Lowongan Baru</a></li>
            </ol>
        </div>
        <!-- row -->
        <div class="row">
            <div class="col-xl-12 col-lg-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Tambah Lowongan Baru</h4>
                    </div>
                    <div class="card-body">
                        <div class="basic-form">
                            <form method="POST" action="{{ route('job_add_post') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3 row">
