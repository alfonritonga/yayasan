                        ...
                        <div class="basic-form">
                            <form method="POST" action="{{ route('job_edit_patch', $job->id) }}"
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" value="{{ $job->title }}" required name="title"
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="date" required value="{{ $job->from }}" name="from"
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="date" required value="{{ $job->to }}" name="to"
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="type" class="form-control">
                                            <option value="1" @if ($job->type == 1) selected @endif>Full
                                                Time</option>
                                            <option value="2" @if ($job->type == 2) selected @endif>Part
                                                Time</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <fieldset class="mb-3">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="status"
                                                    value="false" @if ($job->status == 0) checked @endif>
                                                <label class="form-check-label">
                                                    Tidak Aktif
                                                </label>
                                            </div>
