...
<div class="container-fluid">
    <div class="row page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="javascript:void(0)">Edit Lowongan</a></li>
        </ol>
    </div>
    <!-- row -->
    <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="basic-form">
                        <form method="POST" action="{{ route('job_edit_patch', $job->id) }}"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3 row">
                                <label class="col-sm-3 col-form-label">Judul</label>
                                <div class="col-sm-9">
                                    <input type="text" value="{{ $job->title }}" required name="title" class="form-control" placeholder="Judul">
                                </div>
                            </div>
                            <div class="mb-3 row custom-ekeditor">
                                <label class="col-sm-3 col-form-label">Deskripsi</label>
                                <div class="col-sm-9">
                                    <input type="text" required value="{{ $job->description }}" name="description" class="form-control">
                                </div>
                            </div>
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="date" required value="{{ $job->from }}" name="from" class="form-control">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label class="col-sm-3 col-form-label">Sampai Tanggal</label>
                                <div class="col-sm-9">
                                    <input type="date" required value="{{ $job->to }}" name="to" class="form-control">
                                </div>
                            </div>
                            <fieldset class="mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="status" value="false" @if ($job->status == 0) checked @endif>
                                            <label class="form-check-label">
                                                Tidak Aktif
                                            </label>
                                        </div>
