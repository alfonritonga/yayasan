...
@section('title', 'Ubah Video Kegiatan UYT')
    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">Ubah Video UYT</a></li>
            </ol>
        </div>
        <!-- row -->
        <div class="row">
            <div class="col-xl-12 col-lg-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Ubah Video Dokumentasi UYT</h4>
                    </div>
                    <div class="card-body">
                        <div class="basic-form">
                            <form method="POST" action="{{ route('admin_uyt_videos_edit', $video->id) }}"
