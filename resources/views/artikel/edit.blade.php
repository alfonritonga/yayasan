                    ...
                    <div class="basic-form">
                        <form method="POST" action="{{ route('article_edit_patch', $article->id) }}"
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" value="{{ $article->title }}" required name="title" class="form-control" placeholder="Judul">
                                </div>
                            </div>
                            <div class="mb-3 row custom-ekeditor">
                                <label class="col-sm-3 col-form-label">Deskripsi</label>
                                <div class="col-sm-9">
                                    <input type="text" required value="{{ $article->description }}" name="description" class="form-control">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label class="col-sm-3 col-form-label">Media</label>
                                <div class="col-sm-9">
                                    <img src="../../{{ $article->media }}" width="200" height="200">
                                    <br>
                            ...
                            <fieldset class="mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="status" value="false" @if ($article->status == 0) checked @endif>
                                            <label class="form-check-label">
                                                Tidak Aktif
                                            </label>
                                        </div>
