...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <ol class="breadcrumb">
            <li class="breadcrumb-item active"><a href="javascript:void(0)">Artikel Terbaru</a></li>
            <li class="breadcrumb-item"><a href="javascript:void(0)">Artikel Terbaru</a></li>
        </ol>
    </div>
    <!-- row -->
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="col-xl- d-flex flex-column align-items-end">
                        <a href="article/add-article" class="btn btn-outline-primary">Tambah Data</a>
                    </div>
                    <!-- </div> -->
                </div>
                <div class="card-body">
