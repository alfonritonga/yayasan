                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="col-xl- d-flex flex-column align-items-end">
                            <a href="{{ route('photo_add_view') }}" class="btn btn-outline-primary">Tambah Data</a>
                        </div>
                        <!-- </div> -->
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($photos as $x)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <a href="{{ route('photo_edit_view', $x->id) }}"
                    ...
                    if (willDelete) {
                        ...
                        $.ajax({
                            ...
                            success: function(res, data) {
                                if (res.status == true) {
                                    swal("Success", "Photo udah berhasil di hapus yaa!", "success");
