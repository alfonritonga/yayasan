...
<html lang="en">
  <head>
    ...
    <meta
      ...
      <title>{{ config('app.name', 'Yayasan') }} &mdash; @yield('title')</title>
				...
				<div class="dropdown header-profile">
					<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
						...
						<div class="header-info">
							<span class="font-w400 mb-0">Hello, <b>{{ Auth::user()->first_name }} {{ Auth::user()->last_name }}</b></span>
				...
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							<li><a href="index.html">Sejarah YLKA</a></li>
							<li><a href="index-2.html">Visi, Misi, & Nilai</a></li>
							<li><a href="coin-details.html">Kemitraan</a></li>	
						</ul>
                    ...
                    <li><a href="/donation" class="ai-icon" aria-expanded="false">
					...
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							<li><a href="/partner/category">Category Partner</a></li>
							<li><a href="/partner/list">List Partner</a></li>	
						</ul>
