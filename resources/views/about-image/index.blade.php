    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="javascript:void(0)">Gambar Tentang</a></li>
            </ol>
        </div>
        <!-- row -->
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <!-- <div class="row"> -->
                        <div class="col-xl-6">
                            <h4 class="card-title">Gambar Tentang</h4>
                        </div>
                        <div class="col-xl- d-flex flex-column align-items-end">
                            <a href="{{ route('about-image_add_view') }}" class="btn btn-outline-primary">Tambah Data</a>
                        </div>
                        <!-- </div> -->
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($about_images as $x)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <a href="{{ route('about-image_edit_view', $x->id) }}"
                    ...
                    if (willDelete) {
                        ...
                        $.ajax({
                            ...
                            success: function(res, data) {
                                if (res.status == true) {
                                    swal("Success", "Gambar tentang udah berhasil di hapus yaa!",
                                        "success");
