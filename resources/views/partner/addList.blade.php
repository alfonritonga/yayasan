...
<div class="container-fluid">
    <div class="row page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="javascript:void(0)">Tambah List Partner</a></li>
        </ol>
    </div>
    <!-- row -->
    <div class="row">
        <div class="col-xl-12 col-lg-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Tambah List Partner</h4>
                </div>
                <div class="card-body">
                    <div class="basic-form">
                        <form method="POST" action="{{ route('list_add_post') }}"
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <select id="single-select" name="partner_id" required class="form-control">
